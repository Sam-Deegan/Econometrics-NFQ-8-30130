# Robust vs classical standard errors

Lecture 4.1. **Not built.**

Slider on the severity of heteroskedasticity, with the two variance estimates side by side. Roughly thirty lines.
