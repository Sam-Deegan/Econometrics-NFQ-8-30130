...
Lecture 1.2. **Not built.**

Show $E[y|x]$ as a curve through binned means, with the regression line laid over it. The point students miss is that regression approximates something that already exists in the data.
